...
@app.task
def send_register_confirmation_email_celery(receiver_email: str, code: str) -> None:
    """
...
def send_new_preferences_to_all_users_celery() -> None:
    ...
    for account in all_accounts:
        recommended_for_adding_priorities = all_priorities.exclude(priorities_name_id__in=account.precedents.values('priorities_name_id'))[:3]
